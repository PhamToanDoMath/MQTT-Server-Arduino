...
#define AIO_KEY          "aio_fqHd226y3oMbMSvZkPUHBx8LoSTM"
...
Adafruit_MQTT_Subscribe light_sensor = Adafruit_MQTT_Subscribe(&mqtt, "lgk1910/feeds/light-sensor");
